...
import { SafeAreaView, StyleSheet, View, Text, Pressable, LayoutChangeEvent } from 'react-native'
...
const TabBarComponent = ({ active, onLayout, onPress, options }: TabBarComponentProps) => {
